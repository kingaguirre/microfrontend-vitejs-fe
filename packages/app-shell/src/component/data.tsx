...
export const NOTIFICATIONS = [
  {
    ...
    messageContent: <button onClick={() => alert('Custom button clicked!')}>Click Me</button>
  },
  {
    id: 2,
    type: 'default',
  ...
  },
  {
    ...
    // 2 years ago
    dateTime: new Date(Date.now() - 2 * 365 * 24 * 60 * 60 * 1000).toISOString(),
  ...
  },
  {
    ...
    // 5 years ago
    dateTime: new Date(Date.now() - 5 * 365 * 24 * 60 * 60 * 1000).toISOString(),
    isNew: true,
    onClick: () => alert('Message notification clicked')
  }
]

// Static definition of extra sub-menus to inject
export const STATIC_SUB_MENUS = [
  {
    menu: 'toolkit',
    subMenu: [
      {
        id: 'submenu-toolkit',
        icon: 'toys',
        title: 'Toolkit Submenu',
        onClick: (navigate: Function) => navigate('/toolkit/sub', { replace: true })
      }
    ]
  },
  {
    ...
    subMenu: [
      {
        ...
        icon: 'timeline',
        title: 'Query Submenu',
        onClick: (navigate: Function) => navigate('/query/sub', { replace: true })
      }
    ]
  }
]

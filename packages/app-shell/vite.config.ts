    ...
    plugins: [
      ...
      federation({
        ...
        remotes: {
          ...
          txnenquiry: env.VITE_REMOTE_TXNENQUIRY || 'http://localhost:4008/assets/remoteEntry.js',
          /* __MODULE_txnenquiry_END */
          /* __MODULE_statement-browser_START */
          'statement-browser':
            env.VITE_REMOTE_STATEMENT_BROWSER || 'http://localhost:4007/assets/remoteEntry.js',
          /* __MODULE_statement-browser_END */
          /* __MODULE_txnworkdesk_START */
          txnworkdesk: env.VITE_REMOTE_TXNWORKDESK || 'http://localhost:4006/assets/remoteEntry.js',
          /* __MODULE_txnworkdesk_END */
          /* __MODULE_ackworkdesk_START */
          ackworkdesk: env.VITE_REMOTE_ACKWORKDESK || 'http://localhost:4005/assets/remoteEntry.js',
          /* __MODULE_ackworkdesk_END */
          /* __MODULE_setup_START */
          setup: env.VITE_REMOTE_SETUP || 'http://localhost:4004/assets/remoteEntry.js',
          /* __MODULE_setup_END */
          toolkit: env.VITE_REMOTE_TOOLKIT || 'http://localhost:4001/assets/remoteEntry.js',
          query: env.VITE_REMOTE_QUERY || 'http://localhost:4002/assets/remoteEntry.js'
        },
        shared: {

                ...
                dataTable: {
                  ...
                  fields: [
                    ...
                    },
                    {
                      ...
                      disabled: true,
                      col: { md: 3 },
                      placeholder: 'Enter Address Line 6'
                    },
                    {
                      name: 'addr7',
                      ...
                      disabled: true,
                      col: { md: 3 },
                      placeholder: 'Enter Address Line 7'
                    },
                    {
                      name: 'country',
                      label: 'Country',
                    ...
                    },
                    {
                      ...
                      disabled: true,
                      col: { md: 3 },
                      placeholder: 'Enter Mail Zip Code'
                    },
                    {
                      name: 'provinceCode',
                      label: 'Province Code',
                    ...
                    {
                      name: 'indiaStateCode',
                      label: 'India State Code',
                      type: 'text',
                      disabled: true,
                      col: { md: 3 },
                      placeholder: 'Enter India State Code'
                    },
                    {
                      name: 'specEcoArea',
                      label: 'Special Economic Area',
                      type: 'text',
                      disabled: true,
                      col: { md: 3 },
                      placeholder: 'Enter Special Economic Area'
                    }
                  ]
                }
              }
            ...
            fields: [
              {
                dataTable: {
                  ...
                  fields: [
                    {
                      name: 'llsAddrId',
                      label: 'LLS Address ID',
                      type: 'text',
                      disabled: true,
                      col: { md: 4 },
                      placeholder: 'Enter LLS Address ID'
                    },
                    {
                      name: 'llsLine1',
                      label: 'Address Line 1',
            ...
            fields: [
              {
                dataTable: {
                  ...
                  fields: [
                    {
                      name: 'sciId',
                      label: 'Sub Profile ID',
                      type: 'text',
                      disabled: true,
                      col: { md: 4 },
                      placeholder: 'Enter Sub Profile ID'
                    },
                    {
                      name: 'sciType',
                      label: 'Sub Type',
